document.addEventListener('DOMContentLoaded', () => {
    ...
    // Page overlays and their corresponding buttons in the menu
    const pages = {
        'about-btn': document.getElementById('about-page'),
        'terms-btn': document.getElementById('terms-page'),
        'privacy-btn': document.getElementById('privacy-page'),
        'feedback-btn': document.getElementById('feedback-page')
    };
    ...
    floatingMenu.addEventListener('click', (e) => {
        e.stopPropagation(); // Prevents the menu from closing when clicking inside it
        const menuItem = e.target.closest('.menu-item');
        if (menuItem) {
            const pageToShow = pages[menuItem.id];
            if (pageToShow) {
                showPage(pageToShow);
            }
        }
    ...
    // --- Original Offline Username Generator ---
